...
public class GetUBSMainPageEndpoint extends Endpoint {
    ...
    private static final String PATH = "/global/en.html";
    ...
    public Response getUBSMain(Session session) {return get(session.getRequestSpecBuilder().build());
    }
}
